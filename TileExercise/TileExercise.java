...
public class TileExercise{
    ...
    public void doLeft(){  
        ...
        {
            Tile n = tiles[this.selectedIndex];
            tiles[this.selectedIndex] =  tiles[this.selectedIndex-1];
            tiles[this.selectedIndex-1] = n;
        }
    }
     ...
     */
    public void doRight(){
        if(this.selectedIndex<tiles.length)
        {
            Tile n = tiles[this.selectedIndex];
            tiles[this.selectedIndex] =  tiles[this.selectedIndex+1];
            tiles[this.selectedIndex+1] = n;
    ...
    public void doRemove(){
        if(tiles[this.selectedIndex]!=null)
        {
            tiles[this.selectedIndex]=null;
        }
    }
